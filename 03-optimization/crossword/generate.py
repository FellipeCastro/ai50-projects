...
class CrosswordCreator():
    ...
    def order_domain_values(self, var, assignment):
        ...
        ruled_out_counts = {}
        # For each word in the domain of var, count how many values it rules out for neighboring variables
        for word in self.domains[var]:
            ...
            for neighbor in self.crossword.neighbors(var):
                ...
                if neighbor not in assignment:
                    overlap = self.crossword.overlaps[var, neighbor]
                    # If there is an overlap, check if the letters at the overlapping position match
                    if overlap is not None:
                        i, j = overlap
                        # Count how many words in the neighbor's domain do not match the current word at the overlapping position
                        for neighbor_word in self.domains[neighbor]:
                            if word[i] != neighbor_word[j]:
                                count += 1
            ruled_out_counts[word] = count

        # Sort words by the number of ruled out values (ascending)
        return sorted(self.domains[var], key=lambda w: ruled_out_counts[w])
    ...
    def select_unassigned_variable(self, assignment):
        ...
        # Sort unassigned variables by the number of remaining values (ascending)
        # and then by degree (descending)
    ...
    def backtrack(self, assignment):
        ...
        for value in self.order_domain_values(var, assignment):
            # Create a new assignment with the current variable and value
